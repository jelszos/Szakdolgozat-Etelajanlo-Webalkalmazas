      ...
      <div class="col-md-8">
        <b-form @submit.prevent="doLogin()">
          ...
          <div style="display: flex; justify-content: center">
            <b-button data-cy="submit" type="submit" variant="primary" class="w-100" v-text="t$('login.form.button')"></b-button>
          </div>
        </b-form>
        <p></p>
        <div>
          <b-alert show variant="warning">
            <b-link :to="'/register'" class="alert-link" v-text="t$('global.messages.info.register.noaccount')"></b-link>
          </b-alert>
        </div>
      </div>
    </div>
