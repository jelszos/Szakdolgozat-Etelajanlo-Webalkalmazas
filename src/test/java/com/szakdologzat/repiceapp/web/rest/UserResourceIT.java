...
class UserResourceIT {
    ...
    private static final String UPDATED_LOGIN = "jamesdon";

    private static final Long DEFAULT_ID = 1L;

    private static final String DEFAULT_EMAIL = "johndoe@localhost";
    private static final String UPDATED_EMAIL = "jamesdon@localhost";

    private static final String DEFAULT_FIRSTNAME = "john";
    private static final String UPDATED_FIRSTNAME = "james";

    private static final String DEFAULT_LASTNAME = "doe";
    private static final String UPDATED_LASTNAME = "don";

    private static final Integer DEFAULT_AVATAR = 1;
    private static final Integer UPDATED_AVATAR = 2;
    ...
    public static User createEntity() {
        ...
        persistUser.setAvatar(DEFAULT_AVATAR);
    ...
    void createUser() throws Exception {
        ...
        userDTO.setAvatar(DEFAULT_AVATAR);
        ...
        assertThat(convertedUser.getAvatar()).isEqualTo(DEFAULT_AVATAR);
    ...
    void updateUser() throws Exception {
        ...
        userDTO.setAvatar(UPDATED_AVATAR);
    ...
    void updateUserExistingLogin() throws Exception {
        ...
        User anotherUser = new User();
        anotherUser.setLogin(UPDATED_LOGIN);
        anotherUser.setPassword(RandomStringUtils.randomAlphanumeric(60));
        anotherUser.setActivated(true);
        anotherUser.setEmail(UPDATED_EMAIL);
        anotherUser.setFirstName(UPDATED_FIRSTNAME);
        anotherUser.setLastName(UPDATED_LASTNAME);
        anotherUser.setAvatar(UPDATED_AVATAR);
        anotherUser.setLangKey("en");
        userRepository.saveAndFlush(anotherUser);
        ...
        AdminUserDTO userDTO = new AdminUserDTO();
        userDTO.setId(anotherUser.getId());
        userDTO.setLogin(updatedUser.getLogin());
        userDTO.setFirstName(updatedUser.getFirstName());
        userDTO.setLastName(updatedUser.getLastName());
